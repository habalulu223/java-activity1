            ...
            switch(choice) {
                    ...
                    do {
                        ...
                        if (bankingChoice == 1) {
                            ...
                            if (loggedIn) {
                                ...
                                while (!exitBanking) {
                                    ...
                                    switch(menuChoice) {
                                        ...
                                        case 2:
                                            ...
                                            if (withdraw > 0 && withdraw <= accountBalances[currentAccountIndex]) {
                                                accountBalances[currentAccountIndex] -= withdraw;
                                ...
                                System.out.println("Maximum attempts reached. Returning to Banking Menu...");
                            }
                            ...
                            if (accountCount < MAX_ACCOUNTS) {
                                ...
                                if (!exists) {
                                    ...
                                    accountNumbers[accountCount] = newAccNo;
                                    accountPins[accountCount] = pin;
                                    accountBalances[accountCount] = 0.0f;
                                    accountCount++;
                                ...
                                System.out.println("Maximum accounts reached. Cannot register new account.");
                            }
                        } else if (bankingChoice == 3) {
                            backToBankingMenu = true;
                        } else {
                            System.out.println("Invalid choice");
                        }
                    } while (!backToBankingMenu);
                    break;
                ...
                case 4:
                    ...
                    if (accountCount == 0) {
                        ...
                        System.out.println("--------------------------------");
                        for (int i = 0; i < accountCount; i++) {
                            System.out.printf("%-15d %-10d %-10.2f\n", 
                                accountNumbers[i], accountPins[i], accountBalances[i]);
                        }
                    }
